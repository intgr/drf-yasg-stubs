...
class BaseInspector:
    ...
    components: Any = ...
    request: Any = ...
    def __init__(self, view: Any, path: Any, method: Any, components: Any, request: Any) -> None: ...
...
class FieldInspector(BaseInspector):
    ...
    def __init__(
        self, view: Any, path: Any, method: Any, components: Any, request: Any, field_inspectors: Any
    ) -> None: ...
...
class ViewInspector(BaseInspector):
    ...
    overrides: Any = ...
    def __init__(self, view: Any, path: Any, method: Any, components: Any, request: Any, overrides: Any) -> None: ...
